...
func init() {
	...
	issueCommentAddCmd.Flags().String("model", "", "Sessions model selector for this delegated run. Requires exactly one explicit agent mention; does not change the agent default.")
