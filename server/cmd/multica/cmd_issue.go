...
func init() {
	...
	issueCommentAddCmd.Flags().String("model", "", "Model selector for this delegated run. Requires exactly one explicit agent mention whose runtime supports model selection; does not change the agent default.")
